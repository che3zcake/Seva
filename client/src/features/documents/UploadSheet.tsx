    ...
    <Sheet
      ...
      title={
        stage === 'result'
          ...
          : `Upload ${requirement?.title.toLowerCase()}`
      }
    ...
    >
      {stage === 'choose' ? (
        <div className="space-y-5">
          <p className="text-muted">
            ...
            file is <strong>not actually read</strong> — the checks that follow are simulated, and
            the file is discarded immediately. Nothing is stored.
          </p>
      ...
      {stage === 'analysing' ? (
        <div className="space-y-3 py-4">
          <Spinner label="Simulating a document read…" />
      ...
      {stage === 'result' && analysis ? (
        <div className="space-y-5">
          <p className="rounded-xl bg-paper p-3 text-sm text-muted">
            These results are generated by this prototype, not by reading the file.
          </p>
